...
export default class Container extends Component {
  ...
  handleStart = () => {
    ...
    sampler = new Tone.Sampler({
      urls: {
        ...
        A4: '00001-Linn-9000-BassDrumrum1.mp3',
        A5: '00017-Linn-9000-Snare.mp3',
        A6: 'Abletunes - 808 36 A.wav',
        A7: '00064-Vermona-DRM1-MK3-Tom13.mp3',
        A8: '00056-Vermona-DRM1-MK3-HH01.mp3'
      },
  ...
  handleMelodyValueChange = (property, value) => {
    ...
    } else if (property === 'melodyAutoWahWet') {
      ...
      <div className="instrumentUI">
        ...
        <div class="MelodySettings">
          ...
          <Surface
            ...
            maxX="1"
            stepX="0.01"
            valueX={melodySettings.autoWah.wet}
            propertyX="melodyAutoWahWet"
            minY="0"
            maxY="1"
            stepY="0.01"
        ...
        <div className="Background"></div>
        <div className="podloz"></div>
        <div className="podloz1"></div>
        <div className="podloz2"></div>
        <div className="podloz3"></div>
        <div className="podloz4"></div>
        <div className="First_text">SYNTH PLANET-U53</div>
        <div class="DrumsSettings">
          <Channel
